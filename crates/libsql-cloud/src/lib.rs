...
//!
//! // HARDCODED_SCHEMA: 92 tables in unified_schema.sql (91 Rust + 1 browser-specific blockchain_proofs) (verified 2026-01-02)
//! Uses the unified 92-table schema from migrations/unified_schema.sql.
...
/// // HARDCODED_SCHEMA: 92 tables (verified 2026-01-02)
...
impl CloudClient {
    ...
    pub async fn initialize_schema(&self) -> Result<()> {
        info!("Initializing cloud database with unified schema (92 tables)");
